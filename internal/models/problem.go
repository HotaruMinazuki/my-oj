...
type CommChannel struct {
	Name         string `json:"name"`           // 调试用名称，如 "pipe_0"
...
// Stored as JSONB so the schema evolves without ALTER TABLE.
//
...
type Problem struct {
	...
	// AllowedLangs is nil when all configured languages are allowed.
